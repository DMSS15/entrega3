...
public class Tecnico extends Usuario{
   ...
   @OneToMany (mappedBy = "baja")
    ...
    @ManyToMany (mappedBy="tecnicoESTAreunion")
    private List<Reunion> tecnicoAreunion;
    ...
    public List<Reunion> getTecnicoAreunion() {
        return tecnicoAreunion;
    }

    public void setTecnicoAreunion(List<Reunion> tecnicoESTAreunion) {
        this.tecnicoAreunion = tecnicoESTAreunion;
    }
